...
class PhysicalInventoryMolecule extends StatelessWidget {
  final ArticleEnquiryViewModel model;

  const PhysicalInventoryMolecule({required this.model, super.key});
          ...
          return snapshot == false ? Column(
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    Text("Nestle Baby&Me Vanilla 400gm ", style: TextStyle(
          ...
          AppStreamBuilder<bool>(
              ...
              dataBuilder: (context, snapshot) {
                ...
                CommonLineItemsWidget(
                  ...
                  idNumber: '12687',
                  oneEa: 'EA',
                  itemName: 'Nestle Baby&Me Vanilla 400gm', onPressed: () {
                    showCommonAlertDialog(
                      context: context,
                      title: 'Message',
                      message: 'Successfully updated 1 article under Doc.No 8162',
