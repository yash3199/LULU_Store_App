...
class StockTransportMolecule extends StatelessWidget {
  final ArticleEnquiryViewModel model;

  const StockTransportMolecule({required this.model, super.key});
                        ...
                        : Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                      begin:
                                          Alignment.topLeft, // Start position
                                ...
                                Center(
                                  child: Text("STO Creation Successful!",
                                      style: TextStyle(
                                        color: AppColors.greenGradientShade2,
                                        fontSize: 16,
                                        fontWeight: FontWeight.w500,
                                        fontFamily:
                                            GoogleFonts.notoSans().fontFamily,
