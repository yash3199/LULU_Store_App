...
class ProductionOrderWidget
    extends BasePageViewWidget<ProductionOrderViewModel> {
  const ProductionOrderWidget(super.model, {super.key});

  @override
  Widget build(BuildContext context, ProductionOrderViewModel model) {
    return Column(
      children: [
        Padding(
